class ConfsController < ApplicationController
  def show
    ...
    when 5
      ["Eli Duke", "Evan Phoenix", "Leah Silber", "Sarah Mei", "Tj Nelson Jr", "Suzan Bond", "Greg Bennick", "Brian", "Mitch Artman", "Tara Brown", "Ron Evans", "willowbl00", "Megan Dean", "Jacob Appelbaum", "Jessica Lord"]
    else
      []
    end
