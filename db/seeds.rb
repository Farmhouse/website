...
farmhouse_conf_5 = Conf.create!(
  ...
  :year             => 2013,
  :starts_at        => DateTime.parse("2013-11-02 08:30"),
...
episodes = [
  ...
  },
  {
    ...
    :show_notes       => %Q{
      <a href="http://www.youtube.com/watch?v=vCadcBR95oU" title="Salt-N-Pepa - Push It">Push It</a>
  ...
  },
  {
    ...
    :show_notes       => %Q{
      ...
      <a href="http://youtube.com/watch?v=yd8jh9QYfEs" title="Rihanna - Don&#39;t Stop The Music">Rihanna - Don't Stop The Music</a>
  ...
  },
  {
    ...
    :show_notes       => %Q{
      ...
      <a href="http://www.youtube.com/watch?v=YUAiTxqBRqE" title="How to Use a Throwing or Rabbit Stick to Hunt Samll Game">How to Use a Throwing or Rabbit Stick to Hunt Small Game</a>
